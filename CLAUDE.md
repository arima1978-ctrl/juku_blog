...
## AI Growth Director(`features.growth_director`、Sprint 1: 基盤 / Sprint 2: GSC連携・校舎ページ認識 / Sprint 3: Page Plan)
...
(Task statusは変更しない。統合Draft生成は未実装)。詳細は`docs/growth_director.md`参照。
